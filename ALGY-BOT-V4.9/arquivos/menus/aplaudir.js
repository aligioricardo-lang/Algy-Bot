  ...
  try {
    ...
    if (mentioned.length === 0) {
      return sock.sendMessage(from, { 
        text: "❌ Marque a mensagem de alguém ou mencione com @ para aplaudir!" 
      }, { quoted: Info });
    }
    ...
    const mensagem = `Você está aplaudindo @${numeroAlvo}! 👏✨`;
    ...
    console.error("❌ Erro no comando aplaudir:", err);
    await sock.sendMessage(from, { 
      text: "⚠️ Ocorreu um erro ao tentar aplaudir! 😂" 
    }, { quoted: Info });
  }
};
