  ...
  try {
    ...
    if (mentioned.length === 0) {
      return sock.sendMessage(from, { 
        text: "❌ Marque a mensagem de alguém ou mencione com @ para dar um beliscão!" 
      }, { quoted: Info });
    }
    ...
    const mensagem = `Você acabou de dar um beliscão em @${numeroAlvo}! 🤏💥😂`;
    ...
    console.error("❌ Erro no comando beliscar:", err);
    await sock.sendMessage(from, { 
      text: "⚠️ Ocorreu um erro ao tentar beliscar! 😂" 
    }, { quoted: Info });
  }
};
