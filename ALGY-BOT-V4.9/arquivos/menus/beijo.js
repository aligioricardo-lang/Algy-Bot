  ...
  try {
    ...
    if (mentioned.length === 0) {
      return sock.sendMessage(from, { 
        text: "❌ Marque a mensagem de alguém ou mencione com @ para dar um beijo!" 
      }, { quoted: Info });
    }
    ...
    const mensagem = `Você acabou de dar um beijo em @${numeroAlvo}! 💋😘✨`;
    ...
    console.error("❌ Erro no comando beijo:", err);
    await sock.sendMessage(from, { 
      text: "⚠️ Ocorreu um erro ao tentar dar um beijo! 😂" 
    }, { quoted: Info });
  }
};
