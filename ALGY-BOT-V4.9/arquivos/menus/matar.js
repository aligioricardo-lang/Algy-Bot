  ...
  try {
    ...
    if (mentioned.length === 0) {
      return sock.sendMessage(from, { 
        text: "❌ Marque a mensagem de alguém ou mencione com @ para matar a pessoa!" 
      }, { quoted: Info });
    }
    ...
    console.error("❌ Erro no comando matar:", err);
    await sock.sendMessage(from, { 
      text: "⚠️ Ocorreu um erro ao tentar matar! 😂" 
    }, { quoted: Info });
  }
};
